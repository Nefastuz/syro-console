...
const openai = new OpenAI({ 
  apiKey: process.env.OPENAI_API_KEY, // Clave del Vercel AI Gateway
  baseURL: process.env.OPENAI_API_BASE, // URL del Vercel AI Gateway
});

const EMBEDDING_MODEL = 'text-embedding-3-small';
// Se especifica el proveedor (Groq) para el modelo original.
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const systemPrompt = `Eres SYRÓ... **Relevant Knowledge (VORO v2 - RAG):**\n${memoryContext}\n\n... (resto de la constitución)`;
